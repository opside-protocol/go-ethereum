...
const (
	...
	InitialBaseFee                  = 1001000000000 // Initial base fee for EIP-1559 blocks.
	MinLimitBaseFee                 = 1000000000000 // The minimum limit BaseFee needs to be consistent with the PriceLimit in txpool.
